...
// Put your answer below -------------------------
//JS will read the code inline - just like CSS, it will proccess what the
//variable is when it is read.  Even though it is x at the beginning it wont be
//when its called in the fuction and the last statement where it is logged.
//Because there is a timer- delay on the function i believe Z will come first and
//then Y.  Also Z and Y are only output cause there is no logging of letter unless letter is Z or Y.
